...
//       try {
//         const url = token
//           ? `${import.meta.env.VITE_API_BASE_URL}/projects/${id}?token=${token}`
...
//         `${import.meta.env.VITE_API_BASE_URL}/projects/${id}/remove-file`,
//         { fileUrl },
//         {
//           headers: {
//             Authorization: token ? undefined : `Bearer ${localStorage.getItem('token')}`
...
//     try {
//       const { data } = await axios.post(
//         `${import.meta.env.VITE_API_BASE_URL}/projects/${id}/rename-file`,
//         { 
//           fileUrl: editingName,
//           newName: tempName
//         },
...
//     window.open(`${import.meta.env.VITE_API_IMAGE_URL}${fileUrl}`, '_blank');
//   };
...
//                         {isImage ? (
//                           <img 
//                             src={`${import.meta.env.VITE_API_IMAGE_URL}${fileUrl}`} 
//                             alt={fileName}
